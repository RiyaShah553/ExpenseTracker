...
import { addCategoryAPI } from "../../react-query/category/categoryServices";
...
const AddCategory = () => {
  ...
  const { mutateAsync, isPending, isError, error, isSuccess } = useMutation({
    mutationFn: addCategoryAPI, //from userServices addCategoryAPI
    mutationKey: ["addCategory"], //same as action type in redux
  });
