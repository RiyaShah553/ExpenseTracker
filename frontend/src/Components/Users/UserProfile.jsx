...
import { updateProfileAPI } from "../../react-query/user/userServices";
...
const UserProfile = () => {
  ...
  const { mutateAsync, isPending, isError, error, isSuccess } = useMutation({
    mutationFn: updateProfileAPI, //from userServices loginAPI
    mutationKey: ["update-profile"], //same as action type in redux
  });
  ...
  return (
    <>
      <div className="max-w-4xl mx-auto my-10 p-8 bg-white rounded-lg shadow-md">
        ...
        {/* Display messages */}
        {isPending && (
          <AlertMessage type="Updating" message="Updating you in ..." />
        )}
        {isError && (
